function moduleProject3() {
  ...
  function buildFooter(footerData) {
    ...
    let contractEmailP = document.createElement('p')
    contractEmailP.classList.add('contact-email')
    contractEmailP.innerHTML = `Email: <a href = "mailto:${footerData.contactEmail}"> ${footerData.contactEmail}</a>`

    companyInfoDiv.appendChild(companyNameP)
    companyInfoDiv.appendChild(addressP)
    companyInfoDiv.appendChild(contractEmailP)
